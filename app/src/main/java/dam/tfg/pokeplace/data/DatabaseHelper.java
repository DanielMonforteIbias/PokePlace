...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    */
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createTableTeams="CREATE TABLE "+TEAMS_TABLE_NAME+" ("+TEAM_USER_ID_COLUMN+" TEXT,"+TEAM_ID_COLUMN+" TEXT, "+TEAM_NAME_COLUMN+" TEXT, PRIMARY KEY("+TEAM_ID_COLUMN+"), FOREIGN KEY("+TEAM_USER_ID_COLUMN+") REFERENCES "+USERS_TABLE_NAME+"("+USER_ID_COLUMN+"))";
        ...
        String createTableTeamPokemon="CREATE TABLE "+TEAM_POKEMON_TABLE_NAME+"("+TEAM_POKEMON_ID_COLUMN+" TEXT PRIMARY KEY, "+TEAM_POKEMON_TEAM_ID_COLUMN+" TEXT, "+TEAM_POKEMON_POKEDEX_NUMBER_COLUMN+" INTEGER, "+TEAM_POKEMON_CUSTOM_NAME_COLUMN+" TEXT, "+TEAM_POKEMON_CUSTOM_SPRITE_COLUMN+" TEXT, FOREIGN KEY("+TEAM_POKEMON_TEAM_ID_COLUMN+") REFERENCES "+TEAMS_TABLE_NAME+"("+TEAM_ID_COLUMN+") ON DELETE CASCADE)";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if(oldVersion<9){
            db.beginTransaction();
            try {
                db.execSQL("CREATE TABLE TEAM_POKEMON_TEMP ("+TEAM_POKEMON_ID_COLUMN+" TEXT PRIMARY KEY, "+TEAM_POKEMON_TEAM_ID_COLUMN+" TEXT, "+TEAM_POKEMON_POKEDEX_NUMBER_COLUMN+" INTEGER, "+TEAM_POKEMON_CUSTOM_NAME_COLUMN+" TEXT, "+TEAM_POKEMON_CUSTOM_SPRITE_COLUMN+" TEXT, FOREIGN KEY("+TEAM_POKEMON_TEAM_ID_COLUMN+") REFERENCES "+TEAMS_TABLE_NAME+"("+TEAM_ID_COLUMN+") ON DELETE CASCADE)");
                ...
                db.execSQL("DROP TABLE "+TEAM_POKEMON_TABLE_NAME);
                db.execSQL("ALTER TABLE TEAM_POKEMON_TEMP RENAME TO "+TEAM_POKEMON_TABLE_NAME);
                db.execSQL("CREATE TABLE TEAM_TEMP ("+TEAM_USER_ID_COLUMN+" TEXT,"+TEAM_ID_COLUMN+" TEXT, "+TEAM_NAME_COLUMN+" TEXT, PRIMARY KEY("+TEAM_ID_COLUMN+"), FOREIGN KEY("+TEAM_USER_ID_COLUMN+") REFERENCES "+USERS_TABLE_NAME+"("+USER_ID_COLUMN+"))");
